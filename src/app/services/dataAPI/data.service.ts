...
export class DataService {
  ...
  /**
   * Este metodo obtiene todos los datos de interfaces de red del host
   * 
   * @param idZabbix - id del host del cual obtendremos los items o datos configurados en el servidor
   * @returns Un objeto observable con los datos obtenidos
   */
  ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  getInterfacesHosts(idZabbix: number): Observable<DatosHosts> {
    const id = 1;
    const url = this.host + this.puerto + '/api_jsonrpc.php';
    const headers = { "Content-Type": "application/json" };
    const req = {
      "jsonrpc": "2.0", "method": "hostinterface.get", "params":
      {
        "hostids": idZabbix,
